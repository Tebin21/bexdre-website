...
/** Hero band for every hub/detail page below Home — clears the fixed Navbar itself, so it never needs SectionWrapper's own top padding. */
export const PageHero: React.FC<PageHeroProps> = ({ eyebrow, title, subtitle, size = 'default', breadcrumbs }) => {
  ...
  return (
    <section className="relative pt-[160px] pb-16 md:pt-[180px] md:pb-20">
