...
/**
 * WebGL strand field via ogl. Ported from the React Bits "Strands" component; the glass-ball
 * variant was dropped since this only ever renders as a flat card background.
 */
export default function Strands({
  colors = ['#24AC7C', '#7EE6C0'],
  count = 3,
  speed = 0.5,
  amplitude = 1,
  waviness = 1,
  ...
  return <div ref={ctnDom} className={`strands-container ${className}`} />;
}
